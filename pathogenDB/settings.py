"""
Django settings for pathogenDB project.
...
SECRET_KEY = 'k^wh$=-@m7#o1%-t4hq$(qc$2!nt%z6*s%206i574-p6i80@x+'
...
ROOT_URLCONF = 'pathogenDB.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'pathogenDB', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pathogenDB.wsgi.application'
