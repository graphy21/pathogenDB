...
class Nomen(models.Model):
	...
	pathogen_human = models.IntegerField(default=0, choices=PATHOGEN)
	pathogen_animal = models.IntegerField(default=0, choices=PATHOGEN)
	pathogen_plant = models.IntegerField(default=0, choices=PATHOGEN)
